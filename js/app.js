  ...
  new Chart($('#pie-chart'), {
    ...
    data: {
      ...
      datasets: [{
        ...
        "#E6313C", "#C4C442"],
        data: [Math.abs(amountFood),
               Math.abs(amountElectronics), 
               Math.abs(amountTrip), 
               Math.abs(amountTransport), 
               Math.abs(amountBeauty), 
               Math.abs(amountClothing), 
               Math.abs(amountEducation), 
               Math.abs(amountBooks), 
               Math.abs(amountMedicine), 
               Math.abs(amountParty), 
               Math.abs(amountHobbies), 
               Math.abs(amountOther)]
      }]
    },
    options: {
      title: {
